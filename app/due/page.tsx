    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-linear-to-b from-background via-violet-500/20 to-violet-500/40" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-xl md:text-2xl text-violet-200 mb-8 max-w-3xl mx-auto leading-relaxed font-medium"
            >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-xl text-violet-300 mb-12 max-w-3xl mx-auto leading-relaxed"
            >
              ...
              {workshopDetails.map((detail, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-xs mb-1 text-violet-200">
                      {detail.label}
                    </div>
      ...
      <section className="py-16 relative bg-linear-to-b from-violet-500/40 via-violet-500/10 to-background">
        <div className="absolute inset-0">
          {/* Grain texture */}
          <div
            className="absolute inset-0 opacity-25 pointer-events-none"
      ...
      <section className="py-32 relative bg-linear-to-b from-violet-500/20 via-violet-500/10 to-background">
        <div className="absolute inset-0">
          {/* Grain texture */}
          <div
            className="absolute inset-0 opacity-25 pointer-events-none"
      ...
      <section className="relative py-32 bg-linear-to-b from-background via-violet-500/10 to-violet-500/60">
        <div className="absolute inset-0">
          {/* Grain texture */}
          <div
            className="absolute inset-0 opacity-25 pointer-events-none"
