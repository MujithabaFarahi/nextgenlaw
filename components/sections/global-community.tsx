          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col justify-center">
              <div className="space-y-6">
                <div className="text-center bg-violet-50 dark:bg-violet-950/20 rounded-2xl p-8 border border-violet-100 dark:border-violet-900/30">
                  <div className="text-5xl font-bold text-violet-600 dark:text-violet-400 mb-3">20,000+</div>
                  <p className="text-gray-600 dark:text-gray-400 text-lg">Active Community Members</p>
                </div>
                <div className="text-center bg-violet-50 dark:bg-violet-950/20 rounded-2xl p-8 border border-violet-100 dark:border-violet-900/30">
                  <div className="text-5xl font-bold text-violet-600 dark:text-violet-400 mb-3">160+</div>
                  <p className="text-gray-600 dark:text-gray-400 text-lg">Countries Represented</p>
                </div>
                <div className="text-center bg-violet-50 dark:bg-violet-950/20 rounded-2xl p-8 border border-violet-100 dark:border-violet-900/30">
                  <div className="text-5xl font-bold text-violet-600 dark:text-violet-400 mb-3">100+</div>
                  <p className="text-gray-600 dark:text-gray-400 text-lg">Monthly Events & Meetups</p>
                </div>
              </div>
            </div>
